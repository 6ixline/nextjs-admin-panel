...
import { CityResponse as DeleteCityResponse, City, PaginatedCityResponse } from '@/types/cityTypes';
...
export const useDeleteCity = () => {
  ...
  const deleteMutation = useMutation<
    DeleteCityResponse,     // Type of data returned by the mutationFn
    Error,                  // Type of error
  ...
  >({
    ...
    // This is what triggers the refetch of the cities list.
    onSettled: () => {
